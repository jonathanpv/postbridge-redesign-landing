            ...
            {isMobileMenuOpen && (
                <div className="lg:hidden border-t border-gray-100 p-4 bg-white rounded-b-2xl">
                    <nav className="flex flex-col space-y-4">
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">Pricing</Link>
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">Reviews</Link>
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">Features</Link>
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">Platform</Link>
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">FAQ</Link>
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">Blog</Link>
                        ...
                        <div className="py-2">
                            ...
                            <div className="grid grid-cols-1 gap-2 mt-2 pl-2">
                                {components.slice(0, 4).map((item) => (
                                    <Link key={item.title} href={item.href} className="text-sm text-gray-600 hover:text-green-500">
                                        {item.title}
                                    </Link>
                                ))}
                            </div>
                        ...
                        <Link href="#" className="text-gray-600 font-medium hover:text-green-500">API</Link>
