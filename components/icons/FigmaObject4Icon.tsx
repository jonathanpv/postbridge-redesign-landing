...
const FigmaObject4Icon: React.FC<IconProps> = (props) => {
  return (
    ...
    >
      <defs>
            <linearGradient id={`${id}-Vector-gradient-221-1606`} gradientTransform="matrix(6.123234262925839e-17, -1, 1, 6.123234262925839e-17, 0, 1)">
      ...
      <path
        ...
        fill={`url(#${id}-Vector-gradient-221-1606)`}
      />
