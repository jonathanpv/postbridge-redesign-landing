...
const FigmaObject3Icon: React.FC<IconProps> = (props) => {
  return (
    ...
    >
      <defs>
            <linearGradient id={`${id}-Vector-8356-gradient`} gradientTransform="matrix(-0.01334725134074688, -1.1706821918487549, 1.1473139524459839, -0.10521943867206573, 0.21416521072387695, 1.1493886709213257)">
      ...
      <path
        ...
        fill={`url(#${id}-Vector-8356-gradient)`}
      />
    </svg>
  );
};
