...
const FigmaObject2Icon: React.FC<IconProps> = (props) => {
  return (
    ...
    >
      <defs>
            <linearGradient id="Vector-8354-gradient" gradientTransform="matrix(-0.020332178100943565, -1.0411134958267212, 1.020331621170044, -0.16028320789337158, 0.19529280066490173, 1.0655063390731812)">
